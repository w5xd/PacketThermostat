...
command sets the Packet Thermostat's current operating state and initializes its
settings from EEPROM. If the command is followed by the word "BOOT" it also
sets the EEPROM state to restore this TYPE and MODE should the
